...
!!! e.g. in all pom.xml files: 1.5.0-SNAPSHOT and all eclipse files [MANIFEST.MF, feature.xml, category.xml]: 1.5.0.qualifier !!!

1. update the version in pom.xml: e.g. <newVersion>1.5.1-SNAPSHOT</newVersion>
