...
public class ShellExplore implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (action != null) {
			EasyShellMyAction act = new EasyShellMyAction("com.tetrade.eclipse.plugins.easyshell.actions.EasyShellActionExplore");
